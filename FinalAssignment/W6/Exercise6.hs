...
-- Restrict the items to be between 1 and 10
newtype Item = Item Int deriving (Show, Eq, Ord)

instance Arbitrary Item where
  arbitrary :: Gen Item
  arbitrary = oneof [return (Item n) | n <- [1 .. 10]]
...
prop_relationsAreTransitive :: Rel Item -> Bool
...
prop_intrsectIsTransitive :: Rel Item -> Rel Item -> Bool
