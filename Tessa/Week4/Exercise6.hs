...
-- Write a function testLTSAgainstSUT :: IOLTS -> (State -> Label -> (State, Label)) -> Bool that returns True if the SUT correctly implements 
-- the IOLTS and either returns false or throws an error if it doesn't. 
